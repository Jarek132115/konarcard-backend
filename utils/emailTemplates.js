...
// Separate functions for trial reminders
function trialFirstReminderTemplate(name) {
  return `
        <!DOCTYPE html>
        <html>
        <head>
            <title>Your Free Trial is About to End</title>
            <style>
  ...
  return `
        ...
        <head>
            ...
            <style>
                body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; }
                .container { max-width: 600px; margin: 20px auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; }
                .button { display: inline-block; padding: 10px 20px; margin-top: 15px; background-color: #dc3545; color: #ffffff; text-decoration: none; border-radius: 5px; }
            </style>
        </head>
        <body>
            <div class="container">
